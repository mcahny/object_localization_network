    ...
    train_cfg=dict(
        rpn=dict(
            ...
            objectness_sampler=dict(
                ...
                num=256,
                # <
                # pos_fraction=255/256.,  # 128 + 64 = 192
                pos_fraction=1.,  # 128 + 64 = 192
                # >
                neg_pos_ub=-1,
                add_gt_as_proposals=False),
            # >
...
# work_dir='./work_dirs/oln_box_center_biou_0_256_nonzero/'
work_dir='./work_dirs/oln_box_center_biou_0_256/'